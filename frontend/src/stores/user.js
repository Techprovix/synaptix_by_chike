...
const BASE_URL = "https://synaptix-by-chike-1.onrender.com";
...
export const useUserStore = defineStore("user", () => {
  ...
  const sessionKey = ref(localStorage.getItem("session_key"));

  const refreshKey = ref(localStorage.getItem("refresh_key"));
